...
GENERATE ONE TOUR PATH FOR ALL FOLLOWING TOURS
THEN ALSO GENERATE A PLOTLY ANIMATION
...
![Dendrogram for Wards linkage of the penguins data](gifs/penguins_hflyw.gif){#fig-penguins-hflyw fig-alt="Tour showing the dendrogram for Wards linkage clustering on the penguins data in 4D. You can see that it connects points within each clump and then connects between clusters." fig.align="center"}

![Dendrogram for single linkage of the penguins data](gifs/penguins_hflys.gif){#fig-penguins-hflyw fig-alt="Tour showing the dendrogram for single linkage clustering on the penguins data in 4D. You can see that the connections are like asterisks, connecting towards the center of each clump and there are a couple of long connections between clusters." fig.align="center"}
...
::: {#fig-penguins-cl-wards}
```{=html}
<iframe width="500" height="550" src="html/penguins_cl_ward.html" title="Animation of dendrogram from Wards linkage clustering of the penguins data."></iframe>
```
Animation of dendrogram from Wards linkage clustering of the penguins data.
:::

::: {#fig-penguins-cl-single}
```{=html}
<iframe width="500" height="550" src="html/penguins_cl_single.html" title="Animation of dendrogram from single linkage clustering of the penguins data."></iframe>
```
Animation of dendrogram from single linkage clustering of the penguins data.
:::
<!--
