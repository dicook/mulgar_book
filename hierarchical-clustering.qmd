...
The first step with any clustering is to check the data. You typically don't know whether there are clusters, or what shape they might be, or if there are nuisance observations or variables. A pairs plot like in @fig-penguins-pairs is a nice complement to using the tour for this. Here it looks like you can see three elliptical clusters, with one is further from the others.
...
::: insight
Single linkage on the penguins has a very different joining pattern to Wards!
:::
