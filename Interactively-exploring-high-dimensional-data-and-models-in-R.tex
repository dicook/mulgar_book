...
Figure~\ref{fig-penguins-lda-boundaries-pdf} shows the results.
...
produced by the LDA model in the full 4D with a slice tour (left) and in
the discriminant space (right).}
