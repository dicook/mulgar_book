...
#| fig-alt: "Interactive scatterplot showing a single 2D projection. Mouseover reveals player names. The circle and segments shows the projection coefficients: PC1 points to 6 o'clock, PC2 points to 9 o'clock, PC3 points to 4 o'clock."
#| fig-width: 5
#| fig-height: 4
#| out-width: 80%
library(plotly)
...
#| fig-alt: "Scatterplot showing a single 2D projection. There are 6 points coloured and labelled. Stacey Livingstone is blue and Lauren Ahrens is red  with both around middle right. Dana Hooker is teal, Brittany Bonnici is olive, Kiara Bowers is green and Alyce Parker is pink, and all are at the bottom of the point cloud. The circle and segments shows the projection coefficients: PC1 points to 6 o'clock, PC2 points to 9 o'clock, PC3 points to 4 o'clock."
#| fig-width: 5
#| fig-height: 4
#| out-width: 60%
...
#| fig-alt: "Line plot showing variance vertically against PC number horizontally. Variance drops from close to 3 for PC 1 to about 0.8 for PC 4 then drops to near 0 for PCs 5-7."
#| fig-width: 6
#| fig-height: 4
#| out-width: 80%
...
#| fig-alt: "Line plot with x axis having tick marks at 1, 2, 3, 4, 5, and y axis labelled 'Variance' and ranging from 0 to 2.5. A thick grey line is fairly constant around 1. The black line drops from 2.5 to 1.7 to 0.75 to 0.2 for x going from 1 to 4."
#| fig-width: 6
#| fig-height: 4
#| out-width: 80%
#| fig-pos: H
...
#| fig-alt: "Matrix layout of pairwise plots of five variables, as scatterplots in the lower triangle, density plots on the diagonal, and text showing correlation in the upper triangle. Some nonlinear relationships are visible when PC1 is in the plot, but otherwise there is little association."
#| code-summary: "Code to make scatterplot matrix"
