...
![](images/fashion_confusion_gt_227.png){fig-alt="FIX ME" width="130"}

![](images/fashion_confusion_gt_258.png){fig-alt="FIX ME" width="130"}

![](images/fashion_confusion_gt_275.png){fig-alt="FIX ME" width="130"}

![](images/fashion_confusion_gt_342.png){fig-alt="FIX ME" width="130"}

![](images/fashion_confusion_gt_405.png){fig-alt="FIX ME" width="130"}

![](images/fashion_confusion_gt_433.png){fig-alt="FIX ME" width="130"}
...
::: {.content-visible when-format="html"}
::: insight
There are subsets of confusion. T-shirt/top, Shirt, Pullover, Coat, Dress are mutually confused. Sandals are more often considered to be sneakers. And also where there is confusion the votes take on full range, slightly confused to completely confused.
:::
:::

::: {.content-visible when-format="pdf"}

\insightbox{There are subsets of confusion. T-shirt/top, Shirt, Pullover, Coat, Dress are mutually confused. Sandals are more often considered to be sneakers. And also where there is confusion the votes take on full range, slightly confused to completely confused.
}
:::
