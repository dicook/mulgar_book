...
library(aweSOM)
set.seed(947)
p_grid <- somgrid(xdim = 5, ydim = 5,
                           topo = 'rectangular')
p_init <- somInit(risk, 5, 5)
p_som <- som(risk, 
             rlen=500,
             grid = p_grid,
             init = p_init)
