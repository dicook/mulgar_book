...
![Example solution after spin-and-brush on fake_trees data.](images/fake_trees_sb.png){#fig-fake-trees-sb fig-alt="Projection where some clusters extend in different direction, with point colors indicating the user-identified clusters."}
