...
#| tbl-cap: "List of data sets used in the book examples."
library(gt)
library(gtExtras)
library(gtsummary)
datasets |> gt() |> 
...
This data has 100 numeric variables, and a class variable labelling groups.

#### Variables {-}

|Name         | Description     |
|:------------|:----------------|
|`branches`   | class label     |
|`dim1-dim100`| numeric variables |

#### Purpose {-}

The primary goal is to challenge classification methods to discover the linear branches. 

#### Source {-}

This data is originally from [PHATE](https://github.com/KrishnaswamyLab/PHATE), and is available in the [liminal](https://sa-lee.github.io/liminal/) package.
...
## copula: `copclayton`, `copjoe`, `copfrank`, `copnorm`

#### Description {-}

These dataset have five numeric variables, and a variety of associations. 
