...
[^2.1]: It is generally better to use "associated" than "correlated". Correlated is a statistical quantity, measuring linear association. The term "associated" can be prefaced with the type of association, such as "linear" or "non-linear". 
