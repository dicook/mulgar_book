...
![Grand tour of the pisa data.](){#fig-pisa-gt fig-alt="Tour showing lots of linear projections of the pisa data. You can see strong linear dependence." fig.align="center"}
...
![](){fig-alt="Tour showing lots of linear projections of the aflw data. You can see linear dependence, and some outliers." fig.align="center"}
...
![Model for the 2D in 5D data.](){#fig-plane-model fig-alt="FIX ME." fig.align="center"}

![Model for the 3D in 5D data.](){#fig-box-model fig-alt="FIX ME." fig.align="center"}
...
The model for the `pisa` data is a 1D vector, shown in `r ifelse(knitr::is_html_output(), '@fig-pisa-model-html', '@fig-pisa-model-pdf')`. 
...
![](){fig-alt="Something here" fig.align="center"}
...
![Outliers clearly visible.](){#fig-plane_n_o_clr width=250}

![Outliers not clearly visible in PC1-4.](){#fig-plane_n_o_pca width=250}
...
![Non-linear relationship between several variables seen in a tour on all five variables.](){#fig-nonlinear2  width=250}

![The first three principal components reveal a strong non-linear relationship.](){#fig-plane_nonlin_pca width=250}
