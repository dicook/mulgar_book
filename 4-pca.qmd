...
![](images/aflw_gt_70.png){fig-alt="Example linear projection of the aflw data from a grand tour. You can see linear dependence, and some outliers." fig.align="center"}
...
![](images/pisa_model_17.png){fig-alt="Something here" fig.align="center"}
...
![](images/aflw_model_70.png){ fig-alt="Something here" fig.align="center"}
...
![Outliers clearly visible.](images/plane_n_o_clr_181.png){#fig-plane_n_o_clr width=250}

![Outliers not clearly visible in PC1-4.](images/plane_n_o_pca_181.png){#fig-plane_n_o_pca width=250}
...
![The first three principal components reveal a strong non-linear relationship.](images/plane_nonlin_pca_129.png){#fig-plane_nonlin_pca width=250}
