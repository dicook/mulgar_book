...
In addition, we have made an R package to share the data and functions used in this book, called [`mulgar`](http://dicook.github.io/mulgar).[^mulga]

[^mulga]: Mulga is a type of Australian habitat composed of woodland or open forest dominated by the mulga tree. Massive clearing of mulga led to the vast wheat fields of Western Australia. Here **mulgar** is an acronym for **MU**ltivariate **G**raphical **A**nalysis with **R**.
