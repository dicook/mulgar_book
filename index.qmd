...
and development versions can be installed from the GitHub repositories for the packages. The code and additional data to get started can be found at the book GitHub repo: https://dicook.github.io/mulgar_book. 
