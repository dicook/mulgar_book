...
The PDF version of the book has many static plots replacing the animated gifs and interactive plots available in the
HTML version. This is indicated in the figure caption by the {{< fa play-circle >}} symbol.
...
If you feel like you need to build up your skills in these areas in preparation for working through this book, these are our recommended resources:
...
To get started set up your computer with the current versions of [R](https://cran.r-project.org) and ideally also with [RStudio Desktop](https://posit.co/download/rstudio-desktop/) or [Positron](https://positron.posit.co).

The examples are created using the [`tourr`](http://ggobi.github.io/tourr/) and [`detourr`](https://casperhart.github.io/detourr/) packages. In addition, we have made an R package to share most of the data and functions used in this book, called [`mulgar`](http://dicook.github.io/mulgar).[^mulga][^photo] Ideally the methods described are not entirely bound by the current available packages, and still applicable as new technology arises. To install,
...
and development versions can be installed from the GitHub repositories for the packages. The code and additional data to get started can be found at the book GitHub repo: [https://dicook.github.io/mulgar_book](https://dicook.github.io/mulgar_book).
...
Code in this book is incomplete. It is shown to highlight the essential parts of the code, but the full R files on the repo are needed to run all the examples from the beginning.
:::
...
```bibtex
Cook, D., & Laa, U. (2026). Interactively Exploring High-Dimensional Data and Models in R (1st ed.). Chapman and Hall/CRC. https://doi.org/10.1201/9781003471202
