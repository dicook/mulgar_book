...
\index{data!Australian election}
\index{data!c1-c7}
\index{data!anomaly}
\index{data!assoc}
\index{data!copula}
...
4. Examine each of the challenge data sets `c1`, `c2`, ..., `c7` from the `mulgar` package for signs of the observed values not filling out the full $p$ dimensions.
