...
#| fig-cap: "Two non-linear embeddings of the nonlinear clusters data: (a) t-SNE, (b) UMAP. Both suggest four clusters, with two being non-linear in some form."
#| fig-width: 8
#| fig-height: 4
#| message: false
library(mulgar)
...
6. CHALLENGE: Generate the linked plots (t-SNE, tour) using plotly and crosstalk alone. (Code from  @sec-clust-graphics might help here.)
