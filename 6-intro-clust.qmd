...
9. Use a tour to look at each of the challenge data sets c1, c2, . . . , c7 from the mulgar package. For which ones do you observe clearly separated clusters? Do you notice any shapes that should be taken into account for a cluster analysis?
