...
![](images/shadow_puppets.png){width=450 fig-align="center" fig-env="figure*" fig-cap="Viewing high dimensions using low-dimensional displays is like playing shadow puppets, looking at the shadows to guess what the shape is."}
...
::: {#fig-explain-1D-html layout-ncol=2 fig-env="figure*" layout-align="center" .content-visible when-format="html"}
...
![1D grand tour of the 2D data](gifs/explain_1d.gif){fig-alt=""}
...
::: {.content-visible when-format="html" #fig-explain-2D-html layout="[[57, 43]]"}

![2D tour of 3D data](gifs/explain_2d.gif){fig-alt=""}
...
\begin{minipage}{\linewidth}
    ...
    \begin{minipage}[c]{0.8\linewidth} % Adjust width as needed for the text
      % Your text goes here
      \bigskip 
      \textsf{With a tour we slowly rotate the viewing direction, this allows us to see many individual projections and to track movement patterns. Look for interesting structures such as clusters or outlying points. 
      }
      \bigskip 
    \end{minipage}
    \hspace*{3mm} 
