...
![Outliers](images/outlier_intro.png){#fig-tour-clusters width=200 fig-alt="A single 2D projection from a tour shown as a scatterplot, where you can see most points lie along a line, and two points lie separated from the line on each side."}
