...
#| echo: false
#| fig-cap: "Scatterplot matrix of the penguins, with colour indicating species."
#| fig-width: 7
#| fig-height: 6
#| out-width: 80%
#| message: false
...
6. There are several interesting data sets available on the GGobi web site, for example, one of Tukey's original data set `PRIM7` can be read with:
...
Examine this data for different types of patterns. The `olive`, `PBC`, and `music` data sets are also interesting to explore.
