...
::: {#fig-trails layout-ncol=2 fig-align="center" fig-alt="Two static plots from the animations shown earlier annotated to mark clustering, and outliers, movement. Movement pattern is indicated by a point and a line."}

![Clustering](images/trails-clusters.png){#fig-clusters-trails-static}
