...
![1D tour paths](gifs/tour_paths1d.gif){#fig-tourpaths1d  width=45%}
...
Tour methods are for numerical data, particularly real-valued measurements. If your data is numerical, but discrete the data can look artifically clustered. Here's an example:
...
![Discrete data](gifs/discrete_data.gif){#fig-discrete width=45%}

![Jittered data](gifs/jittered_data.gif){#fig-jittered}
