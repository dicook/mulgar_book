...
The result of a cluster analysis is practically a smaller data set that describes the larger data set more compactly. With this in mind, the key element is a measure of the centre of each cluster. It is also important to obtain a sense of the variability of observations around each centre, and how many observations the size of each cluster are important.
...
```{r echo=knitr::is_html_output()}
#| message: false
#| code-summary: "Code to prepare data for display of confusion"
p_cl <- p_cl |> 
